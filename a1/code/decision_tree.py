...
class DecisionTree:
	...
	def printTree(self, depth):
		print ("\n depth ", depth, " splitVariable ", self.splitModel.splitVariable, " splitValue ", self.splitModel.splitValue)
		if self.subModel1 is not None:
			self.subModel1.printTree(depth + 1)
			self.subModel0.printTree(depth + 1)
